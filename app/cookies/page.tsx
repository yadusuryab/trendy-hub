...
export default function CookiesPolicy() {
  return (
    <>
      <Head>
        <title>Cookies Policy - trendyhub</title>
        <meta name="description" content="Learn how trendyhub uses cookies to enhance your browsing experience." />
      </Head>
      <div className="container mx-auto p-6">
        ...
        <ul className="list-disc ml-6">
          <li>
            <strong>Company:</strong> Refers to trendyhub ("the Company", "We", "Us", or "Our").
          </li>
          <li>
          ...
          <li>
            <strong>Website:</strong> Refers to trendyhub, accessible from
            <a href="https://trendyhub.co.in" target="_blank" rel="noopener noreferrer" className="text-blue-500"> trendyhub.co.in</a>.
          </li>
          <li>
        ...
        <p>
          ...
          <a
            href="https://trendyhub.co.in/contact"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-500"
          >
            trendyhub.co.in/contact
          </a>
          .
        </p>
      </div>
