  ...
  return (
    <div className="relative">
      <Dock direction="middle">
        <DockIcon>
          <Link href={process.env.NEXT_PUBLIC_INSTA || 'https://instagram.com/getshopigo'}>
            <IconBrandInstagram className="size-6" />
          </Link>
        </DockIcon>
        <DockIcon>
          <Link href={`${process.env.NEXT_PUBLIC_WHATSAPP}?text=Hi`}>
            {" "}
        ...
        <DockIcon>
          <Link href={`tel:${process.env.NEXT_PUBLIC_PHONE}`}>
            {" "}
            <IconPhoneCall className="size-6 text-primary" />
          </Link>
        </DockIcon>
      </Dock>
    </div>
